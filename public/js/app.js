...
function initAdmin(socket) {
  ...
  socket.on('orderPlaced', function (order) {
    new noty__WEBPACK_IMPORTED_MODULE_2___default.a({
      ...
      timeout: 1000,
      text: 'New Order'
    }).show(); //adding above received order in previous order list
...
function placeOrder(formObject) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/orders', formObject).then(function (res) {
    ...
    }).show(); //To redirect to ordes page
...
var cartCounter = document.querySelector('#cartCounter'); //for each button
...
if (order) {
  ...
  socket.emit('join', "order_".concat(order._id)); //order_hjsjjjsdjknsk
}
...
socket.on('orderUpdated', function (data) {
  ...
  new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
    type: 'success',
    timeout: 1000,
    text: "".concat(updatedOrder.status)
  }).show();
});
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51HvgDuGb2LQBsCkJaqrWmOMXeiCz8vtL1T21jpJQjtCOe2R1iqPWE2xMtFEJpbIZl6q30MDWxtRaVanMyuBhVYj6009Uk9wwGf');

          case 2:
            stripe = _context2.sent;
            card = null; //paymentType based card detail input box
          ...
          case 7:
            paymentType.addEventListener('change', function (e) {
              if (e.target.value === 'card') {
                ...
                card.mount(); //display card details widget
              } else {
                //Nothing
                card.destroy();
              }
...
__webpack_require__(/*! C:\Users\aaasi\OneDrive\Documents\Codes\Node.Js\mypizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\aaasi\OneDrive\Documents\Codes\Node.Js\mypizza\resources\scss\app.scss */"./resources/scss/app.scss");
